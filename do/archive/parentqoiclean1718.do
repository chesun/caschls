********************************************************************************
/* rename and clean parent 1718 survey questions of interest */
********************************************************************************
********************************************************************************
...
foreach i of numlist 9 15/17 27 30/34 {
  gen stragree`i' = 0
  replace stragree`i' = 1 if qoi`i' == 1

  gen agree`i' = 0
  replace agree`i' = 1 if qoi`i' == 2

  gen disagree`i' = 0
  replace disagree`i' = 1 if qoi`i' == 3

  gen strdisagree`i' = 0
  replace strdisagree`i' = 1 if qoi`i' == 4

  gen dontknow`i' = 0
  replace dontknow`i' = 1 if qoi`i' == 5
 ...
 */
 ...
 gen verywell64 = 0
 replace verywell64 = 1 if qoi64 == 1

 gen justokay64 = 0
 replace justokay64 = 1 if qoi64 == 2

 gen notwell64 = 0
 replace notwell64 = 1 if qoi64 == 3

 gen doesnotdo64 = 0
 replace doesnotdo64 = 1 if qoi64 == 4

 gen dontknow64 = 0
 replace dontknow64 = 1 if qoi64 == 5

 gen missing64 = 0
 replace missing6 = 1 if missing(qoi64)
...
label data "cleaned parent 1718 survey questions of interest with percent disagree/agree etc."
compress
save $projdir/dta/buildanalysisdata/qoiclean/parent/parentqoiclean1718, replace
