 ...
 *** macros for my own datasets
 ...
 cd `matthomedir'
 //starting log file
 log using $projdir/log/share/siblingvaregs/va_sibling_out_spec_test_tab.smcl, replace
...
foreach outcome in enr enr_2year enr_4year {
 ...
 translate $projdir/log/share/siblingvaregs/va_sibling_out_spec_test_tab.smcl ///
 $projdir/log/share/siblingvaregs/va_sibling_out_spec_test_tab.log, replace
