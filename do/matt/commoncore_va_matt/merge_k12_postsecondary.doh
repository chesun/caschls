...
local crosswalks "/home/research/ca_ed_lab/users/msnaven/data/restricted_access/clean/crosswalks/"
...
/*merge m:1 cdscode local_student_id ///
	...
	, gen(merge_k12_nsc_lsid) keep(1 3 4 5) update
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_lsid, 3, 4, 5)
drop merge_k12_nsc_lsid*/
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2010_2017_ssid, 3, 4, 5)
replace k12_nsc_2010_2017_match = 1 if inlist(merge_k12_nsc_2010_2017_ssid, 3, 4, 5)
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2010_2017_lsid, 3, 4, 5)
replace k12_nsc_2010_2017_match = 1 if inlist(merge_k12_nsc_2010_2017_lsid, 3, 4, 5)
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2018cde_ssid, 3, 4, 5)
replace k12_nsc_2018cde_match = 1 if inlist(merge_k12_nsc_2018cde_ssid, 3, 4, 5)
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2018cde_lsid, 3, 4, 5)
replace k12_nsc_2018cde_match = 1 if inlist(merge_k12_nsc_2018cde_lsid, 3, 4, 5)
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2019cde_ssid, 3, 4, 5)
replace k12_nsc_2019cde_match = 1 if inlist(merge_k12_nsc_2019cde_ssid, 3, 4, 5)
...
tab grade year
replace k12_nsc_match = 1 if inlist(merge_k12_nsc_2019cde_lsid, 3, 4, 5)
replace k12_nsc_2019cde_match = 1 if inlist(merge_k12_nsc_2019cde_lsid, 3, 4, 5)
